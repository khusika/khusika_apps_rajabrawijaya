...
public class KesenianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.kesenian_toolbar);
        setupToolbar();
    }
    private void setupToolbar(){
        toolbar.setTitle(getString(R.string.kesenian_title));
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                i = new Intent(KesenianActivity.this, OHLKMActivity.class);
